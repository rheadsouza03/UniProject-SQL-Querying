...
ALTER TABLE ONLY public.accomplices
    ADD CONSTRAINT accomplices_robber_id_fkey FOREIGN KEY (robber_id) REFERENCES public.robbers(robber_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.hasaccounts
    ADD CONSTRAINT hasaccounts_bank_name_city_fkey FOREIGN KEY (bank_name, city) REFERENCES public.banks(bank_name, city) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.hasaccounts
    ADD CONSTRAINT hasaccounts_robber_id_fkey FOREIGN KEY (robber_id) REFERENCES public.robbers(robber_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.hasskills
    ADD CONSTRAINT hasskills_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.skills(skill_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.robberies
    ADD CONSTRAINT robberies_bank_name_city_fkey FOREIGN KEY (bank_name, city) REFERENCES public.banks(bank_name, city) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.robberyplans
    ADD CONSTRAINT robberyplans_bank_name_city_fkey FOREIGN KEY (bank_name, city) REFERENCES public.banks(bank_name, city) ON UPDATE CASCADE ON DELETE CASCADE;
